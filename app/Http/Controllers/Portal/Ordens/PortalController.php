    ...
    private function buildShowData(Ordem $ordem): array
    {
        ...
        if ($cliente?->telefone) {
            ...
            $mensagem = implode("\n", [
                ...
                "",
                "*Como acessar:*",
                "1️⃣ Clique no link acima (já entra direto)",
                "2️⃣ Ou acesse o portal e informe: *{$ordem->codigo_publico}* ou o token *{$ordem->token}*",
                "3️⃣ Pronto! Veja o status em tempo real",
                "",
