...
<div class="mb-5 grid grid-cols-2 gap-3 sm:grid-cols-4">
    <div class="flex items-center gap-3 overflow-hidden rounded-2xl bg-white px-4 py-3 shadow-sm ring-1 ring-black/[0.06]">
        ...
        <div>
            <p class="text-[10.5px] font-semibold uppercase tracking-wider text-slate-400">Total</p>
    ...
    <div class="flex items-center gap-3 overflow-hidden rounded-2xl bg-white px-4 py-3 shadow-sm ring-1 ring-black/[0.06]">
        ...
        <div>
            <p class="text-[10.5px] font-semibold uppercase tracking-wider text-slate-400">Em aberto</p>
            <p class="text-[18px] font-bold leading-tight text-slate-900">{{ $stats['abertas'] }}</p>
        </div>
    </div>
    <div class="flex items-center gap-3 overflow-hidden rounded-2xl bg-white px-4 py-3 shadow-sm ring-1 ring-black/[0.06]">
        ...
        <div>
            <p class="text-[10.5px] font-semibold uppercase tracking-wider text-slate-400">Em execução</p>
            <p class="text-[18px] font-bold leading-tight text-slate-900">{{ $stats['execucao'] }}</p>
        </div>
    </div>
    <div class="flex items-center gap-3 overflow-hidden rounded-2xl bg-white px-4 py-3 shadow-sm ring-1 ring-black/[0.06]">
        <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg {{ $stats['atrasadas'] > 0 ? 'bg-red-50' : 'bg-slate-100' }}">
        ...
        <div>
            <p class="text-[10.5px] font-semibold uppercase tracking-wider text-slate-400">Atrasadas</p>
            <p class="text-[18px] font-bold leading-tight {{ $stats['atrasadas'] > 0 ? 'text-red-600' : 'text-slate-900' }}">{{ $stats['atrasadas'] }}</p>
        </div>
    </div>
</div>

{{-- Filter bar (unified card) --}}
<form method="GET" action="{{ route('app.os.index') }}" class="mb-5">
...
<div class="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-black/[0.06]">
    @if($ordens->isEmpty())
        <div class="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p class="text-[14px] font-semibold text-slate-800">Nenhuma OS encontrada</p>
            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b border-slate-100 bg-slate-50/60">
                        <th class="px-5 py-3 text-left text-[10.5px] font-semibold uppercase tracking-wider text-slate-400">Número</th>
                        <th class="px-5 py-3 text-left text-[10.5px] font-semibold uppercase tracking-wider text-slate-400">Cliente</th>
                        <th class="hidden px-5 py-3 text-left text-[10.5px] font-semibold uppercase tracking-wider text-slate-400 md:table-cell">Equipamento</th>
                        <th class="px-5 py-3 text-left text-[10.5px] font-semibold uppercase tracking-wider text-slate-400">Status</th>
                        <th class="hidden px-5 py-3 text-left text-[10.5px] font-semibold uppercase tracking-wider text-slate-400 lg:table-cell">Técnico</th>
                        <th class="hidden px-5 py-3 text-left text-[10.5px] font-semibold uppercase tracking-wider text-slate-400 lg:table-cell">Previsão</th>
                        <th class="hidden px-5 py-3 text-right text-[10.5px] font-semibold uppercase tracking-wider text-slate-400 sm:table-cell">Total</th>
