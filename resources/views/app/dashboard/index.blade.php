        ...
        <div class="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-black/[0.06]"
            ...
            <div class="flex items-center gap-3 px-5 py-3.5">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-[11px]" :class="enabled ? 'text-emerald-600' : 'text-slate-400'"
                       x-text="enabled ? 'Ativo — respondendo clientes' : 'Desativado'"></p>
                </div>
                <button @click="
                    enabled = !enabled;
                    saving = true;
