...
>
    <div class="flex items-start gap-3 p-4">
        ...
        <div class="flex-1 min-w-0">
            <p class="text-sm font-semibold text-red-700 mb-0.5">Erro</p>
...
<div
    ...
    x-transition:leave-start="opacity-100 translate-x-0"
    x-transition:leave-end="opacity-0 translate-x-4"
    class="fixed top-5 right-5 z-50 w-80 rounded-xl bg-white border border-emerald-200 shadow-xl overflow-hidden"
>
    <div class="flex items-start gap-3 p-4">
        ...
        <div class="flex-1 min-w-0">
            <p class="text-sm font-semibold text-emerald-700 mb-0.5">E-mail enviado</p>
    ...
    <div class="h-0.5 bg-emerald-100">
        <div class="h-full bg-emerald-400 transition-all duration-100" :style="`width: ${progress}%`"></div>
    </div>
</div>
@endif
