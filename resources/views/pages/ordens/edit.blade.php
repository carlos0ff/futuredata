...
<div class="mx-auto max-w-4xl">
    ...
    <div class="mb-6 flex items-center gap-3">
        <a href="{{ isset($ordem) ? route('ordens.show', $ordem) : route('ordens.index') }}"
    ...
    <form action="{{ isset($ordem) ? route('ordens.update', $ordem) : route('ordens.store') }}" method="POST" class="space-y-5">
        @csrf
